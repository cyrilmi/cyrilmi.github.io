---
title: 'Appendix S2: Estimating abundance with interruptions in data collection using
  open population spatial capture-recapture models Ecosphere'
author: "C. Milleret, P. Dupont, J. Chipperfield, D. Turek, H. Broseth, O. Gimenez, P. Valpine, R. Bischof"
date: "26 March 2020"
output:
...
This script performs a data set simulation and OPSCR modelling in the presence of sampling interruption with NIMBLE [@NIMBLE; @deValpine2017]. All details about the procedure are provided in Milleret et al. Estimating abundance with interruptions in data collection using open population spatial capture-recapture models. Ecosphere.
...
```{r source, echo=F,message=FALSE,warning=FALSE,cache.comments=TRUE,include=FALSE}
...
for(t in 2:dim(myZ)[2]){
   for(i in 1:nrow(tempCoords)){
      tempCoords[i,]  <- rbinomMNormSourcePPSingle(
          n = 1
        , lowerCoords = lowerCoords
        , upperCoords = upperCoords
